   ...
   public void showInstructions() {
	     JOptionPane instructions = new JOptionPane(null);
	      ...
	      instructions.showMessageDialog
	         (null, "Professor’s remote control is not working! No batteries maybe? Help him change the"+"\nbatteries by dragging and dropping the algorithm instructions in the correct order."
